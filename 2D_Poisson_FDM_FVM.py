...
if option == 1:
    ...
    # plt.spy(A)
    # plt.grid('on')
    # plt.title(r'Structure of Matrix $A$ for $N_x$=' + str(Nx) + r", $N_y$=" + str(Ny))
    ...
    plt.colorbar()
    plt.title(r"Source Function $f(x,y)$ for $N_x$ =" + str(Nx) + r", $N_y$=" + str(Ny))
    plt.xlabel(r"$x$")
    plt.ylabel(r"$y$")
    ...
    plt.colorbar()
    plt.title(r"Solution $u(x,y)$ for $N_x$ =" + str(Nx) + r", $N_y$=" + str(Ny))
    plt.xlabel(r"$x$")
    plt.ylabel(r"$y$")
    ...
    axs[0].set_title(r"Coefficient Function $K_1(x,y)$ for $N_x$ =" + str(Nx) + r", $N_y$=" + str(Ny))
    im2 = axs[1].imshow(K2.T, extent=[LeftX+dx/2, RightX-dx/2, LeftY+dy/2, RightY-dy/2], origin='lower')
    axs[1].set_title(r"Coefficient Function $K_2(x,y)$ for $N_x$ =" + str(Nx) + r", $N_y$=" + str(Ny))
    fig.colorbar(im1)
    fig.colorbar(im2)
    for ax in axs.flat:
    ...
    plt.colorbar()
    plt.title(r"Solution $u(x,y)$ for $K=K_1(x,y)$, $N_x$ =" + str(Nx) + r", $N_y$=" + str(Ny))
    plt.xlabel(r"$x$")
    plt.ylabel(r"$y$")
    ...
    plt.colorbar()
    plt.title(r"Solution $u(x,y)$ for $K=K_2(x,y)$, $N_x$ =" + str(Nx) + r", $N_y$=" + str(Ny))
    plt.xlabel(r"$x$")
    plt.ylabel(r"$y$")
